...
// Admin-only manual trigger for reminder emails — used for testing/demo
export const reminderApi = {
  sendDeadline: () => api.post('/reminders/send-deadline'),
  sendNewJobs:  () => api.post('/reminders/send-new-jobs'),
